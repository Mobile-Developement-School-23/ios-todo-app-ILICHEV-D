...
private extension TaskDetailsViewController {
    ...
    private func setupContainerView() {
        ...
        NSLayoutConstraint.activate([
            ...
            deadlinePickerContainer.trailingAnchor.constraint(equalTo: deadlinePicker.trailingAnchor, constant: padding),
            deadlinePickerContainer.bottomAnchor.constraint(equalTo: deadlinePicker.bottomAnchor, constant: smallPadding),
        ])
    }
