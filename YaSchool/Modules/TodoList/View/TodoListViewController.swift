...
class TodoListViewController: UIViewController {
    ...
    func setupHeaderView() {
        ...
        headerButtonLabel.font =  UIFont.preferredFont(forTextStyle: .subheadline, compatibleWith: UITraitCollection(legibilityWeight: .bold))
...
extension TodoListViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let deleteAction = UIContextualAction(style: .destructive, title: nil) { [weak self] (_, view, _) in
        ...
        let infoAction = UIContextualAction(style: .normal, title: nil) { [weak self] (_, view, _) in
    ...
    func tableView(_ tableView: UITableView, leadingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let checkAction = UIContextualAction(style: .destructive, title: nil) { [weak self] (_, view, _) in
